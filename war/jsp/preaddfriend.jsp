...
.tfbutton::-moz-focus-inner {
	...
	<div align="center">
		...
		<form id="tfnewsearch" method="post" action="/social/addfriend">
			<input type="text" value="enter the id" class="tftextinput"
				name="recieverID" size="30" maxlength="120"><input
				type="submit" value="send" class="tfbutton">
		</form>
		<br> <br>
