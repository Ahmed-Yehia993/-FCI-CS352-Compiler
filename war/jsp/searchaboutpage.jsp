...
.tfbutton::-moz-focus-inner {
    ...
    <br><br><br>
	<div align="center">
		<form id="tfnewsearch" method="post" action="/social/showpage">
			<input type="text" placeholder="enter page id" class="tftextinput" name="pageid"
				size="30" maxlength="120"><input type="submit"
				value="show" class="tfbutton">
		</form>
	</div>
	<br>
	<hr>
